file://<WORKSPACE>/src/main/scala/com/sequoiareasoner/kernel/context/Context.scala
...
action parameters:
offset: 11708
uri: file://<WORKSPACE>/src/main/scala/com/sequoiareasoner/kernel/context/Context.scala
text:
```scala
/*
...
object Context {
 ...
 @inline def saturateAndPush(state: ContextState, ontology: DLOntology, isEqualityReasoningEnabled: Boolean,
  ...
  def makeContext(state: ContextState,
              ...
              incoming: UnboundedChannel[InterContextMessage]): Task[Fiber] = (@@for {
