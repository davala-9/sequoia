file://<WORKSPACE>/src/main/scala/com/sequoiareasoner/kernel/context/ContextRunnable.scala
...
action parameters:
offset: 2490
uri: file://<WORKSPACE>/src/main/scala/com/sequoiareasoner/kernel/context/ContextRunnable.scala
text:
```scala
