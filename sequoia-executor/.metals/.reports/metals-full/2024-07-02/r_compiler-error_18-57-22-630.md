...
### file%3A%2F%2F%2Fhome%2Fpigeon%2FDownloads%2Fmsc%2FMSc-Project%2Fsequoia%2Freasoner-kernel%2Fsrc%2Fmain%2Fscala%2Fcom%2Fsequoiareasoner%2Fkernel%2Fcontext%2FContextStructureManager.scala:241: error: `)` expected but `(` found
    (() => c.saturateAndPush().run()).asInstanceOf[Callable[Unit]]).toList
                            ^
...
//      println("Is empty?: " + provedAtomicQueries(key).isEmpty)
  ...
  val saturationJobs: List[Callable[Unit]] = cs.map(c => {
    Runnable v = c.saturateAndPush()
    return () => v.run():
    (() => c.saturateAndPush().run()).asInstanceOf[Callable[Unit]]).toList
...
scala.meta.internal.parsers.Reporter.syntaxError(Reporter.scala:16)
	...
	scala.meta.internal.parsers.ScalametaParser.inParensOr(ScalametaParser.scala:228)
	scala.meta.internal.parsers.ScalametaParser$PatternContextSensitive.$anonfun$tupleInfixType$1(ScalametaParser.scala:729)
	...
	scala.meta.internal.parsers.ScalametaParser$PatternContextSensitive.tupleInfixType(ScalametaParser.scala:692)
	scala.meta.internal.parsers.ScalametaParser$PatternContextSensitive.infixTypeOrTuple(ScalametaParser.scala:850)
	...
	scala.meta.internal.parsers.ScalametaParser.scala$meta$internal$parsers$ScalametaParser$$typeOrInfixType(ScalametaParser.scala:1365)
	scala.meta.internal.parsers.ScalametaParser.typeOrInfixType(ScalametaParser.scala:1368)
	scala.meta.internal.parsers.ScalametaParser.iter$3(ScalametaParser.scala:1568)
